---
title: 手把手教你用 MSYS2 在 Windows 上搭建 C/C++ 编译环境
date: 2026-02-05 21:24:23
titleSlugified: msys2-c-cpp-setup-windows
tags: ["Windows", "C", "C++", "MinGW-w64", "MSYS2", "GCC"]
categories: ["编程", "C/C++", "环境搭建"]
description: 基于 MSYS2 + Pacman 包管理器，在 Windows 上轻松搭建 MinGW-w64 GCC 编译环境，享受滚动更新和类 Unix 开发体验。
cover:
---
...
![C 编译器对 C23 支持情况表格](/images/mingw-windows-tutorial/01-c23-support.webp)
...
![MinGW-w64 官网介绍](/images/mingw-windows-tutorial/02-mingw-intro.webp)
{% endnote %}
...
![从 MSYS2 官网下载安装包](/images/mingw-windows-tutorial/03-msys2-download.webp)

1. 下载完成后，打开安装包，欢迎界面，点【Next】：

![MSYS2 安装步骤：欢迎界面](/images/mingw-windows-tutorial/04-msys2-welcome.webp)

1. 选择安装路径界面，{% label 建议保持默认 green %}，如果要修改也最好保证安装路径不要有中文和空格，然后点击【Next】：

![MSYS2 安装步骤：选择安装路径](/images/mingw-windows-tutorial/05-msys2-path.webp)

1. 选择开始菜单文件夹界面，保持默认，然后点击【Next】：

![MSYS2 安装步骤：选择开始菜单文件夹](/images/mingw-windows-tutorial/06-msys2-startmenu.webp)

1. 等待安装：

![MSYS2 安装步骤：等待安装](/images/mingw-windows-tutorial/07-msys2-installing.webp)

1. 安装完成，【Run MSYS now.】（安装过程结束后立即运行 MSYS2）可勾可不勾，然后点击【Finish】：

![MSYS2 安装步骤：完成](/images/mingw-windows-tutorial/08-msys2-finish.webp)
...
![MSYS2 更新完成](/images/mingw-windows-tutorial/09-msys2-update.webp)
...
![MSYS2 安装路径下的文件夹](/images/mingw-windows-tutorial/10-msys2-folders.webp)

1. 选择你所安装的工具链对应的文件夹，这里以 `ucrt64` 为例，该文件夹下的 `bin` 文件夹的路径，就是我们要添加到 Path 变量中的值：

![MinGW-w64 安装路径下的 bin 文件夹](/images/mingw-windows-tutorial/11-bin-folder.webp)
...
![配置 Windows 环境变量：运行窗口输入 sysdm.cpl](/images/mingw-windows-tutorial/12-env-run.webp)

1. 依次点击【高级】、【环境变量】，找到【系统变量】的【Path】变量，双击它：

![配置 Windows 环境变量：点击高级](/images/mingw-windows-tutorial/13-env-advanced.webp)

![配置 Windows 环境变量：点击环境变量](/images/mingw-windows-tutorial/14-env-vars.webp)

![配置 Windows 环境变量：找到系统 Path 变量](/images/mingw-windows-tutorial/15-env-path.webp)

1. 然后点击【新建】，粘贴刚才的路径，回车：

![配置 Windows 环境变量：点击新建](/images/mingw-windows-tutorial/16-env-new.webp)

![配置 Windows 环境变量：粘贴路径](/images/mingw-windows-tutorial/17-env-paste.webp)

1. 依次点击 3 次【确定】：

![配置 Windows 环境变量：点击确定 1](/images/mingw-windows-tutorial/18-env-ok-1.webp)

![配置 Windows 环境变量：点击确定 2](/images/mingw-windows-tutorial/19-env-ok-2.webp)

![配置 Windows 环境变量：点击确定 3](/images/mingw-windows-tutorial/20-env-ok-3.webp)

最后打开一个新的终端窗口输入 `gcc --version` 验证一下：

![配置 Windows 环境变量：验证](/images/mingw-windows-tutorial/21-verify-gcc.webp)
